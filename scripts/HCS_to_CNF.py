...
if __name__ == "__main__":
        ...
        print("generating VIG and CNF")
        g, cnf = HCS_to_VIG.generate_VIG(1, depth, leaf_community_size, inter_vars_fraction, degree_per_level)
        ...
        VIG_to_CNF.write_cnf(cnf, g.vcount(), outpath)
        #VIG_to_CNF.print_cnf(cnf, g.vcount())
